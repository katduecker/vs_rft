...
% Input
% - MEG data (here maxfilter) to read in diode signal

% Output
% - 'delay_diode.mat': matrix 'delay_subj' contains minimum and maximum
%  delays of photodiode for each participant, diode and frequency:
%  delay misc4 60 Hz min & max; delay misc5 60 Hz min & max; delay misc4 67
%  Hz min & max; delay misc5 67 Hz min & max;
...
function c1_phase_locked_diode(s)
%% Paths
