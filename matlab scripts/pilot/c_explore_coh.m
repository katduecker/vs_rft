...
save(fullfile(pthout,[subjcode,'_coh_mtlb_freqbands_N',num2str(N),'.mat']),'coh60misc4', 'psdmeg60misc4', 'psdmisc60misc4','csd60misc4')
...
xlim([-1.5 4])
colorbar
print(fig, fullfile(figpth,['psd_meg_diode_mtlb_filtN_',N]),'-dpng')
