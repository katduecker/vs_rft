...
function [coh_spct, psd_meg, psd_misc,csd_meg_misc] = kd_coh_hilb_mtlb(data, foi, diodelabel, fs, N, padl,frqwdth)
...
for f = 1:length(foi)
    ...
    for t = 1:length(data.trial)
        ...
        filtdat = kd_bp_filt('bp',data.trial{t},foi(f),N,frqwdth,fs);
